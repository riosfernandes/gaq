...
class Login extends MY_Public_Controller {
    ...
    function index() {
        ...
        /* método utilizando o post via form
         * do codeigniter.
         */
...
//            $retorno = $this->logar();
//            if ($retorno == false) {
//                $this->error = '<div class="error">Usuário informado não encontrado.</div>';
//                $this->loadLogin();
//            } else {
//                redirect('welcome');
//            }
//        }
    ...
    /* método utilizado pelo post via form
     * do codeigniter
     */
    ...
    private function logar() {
        ...
        if ($u->result_count() != 1) {
            //@todo: dar mensagem usuário não localizado            
            return FALSE;
        }
        ...
        // insere data e hora do último login
